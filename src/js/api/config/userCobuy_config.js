...
store.subscribe(() => {
    userCobuy_config.fundings = store.getState().userCobuy.cobuyFund;
    userCobuy_config.hits = store.getState().userCobuy.cobuyHit;
});

const userCobuy_config = {
    fundings: [],
    hits: [],
};

export default userCobuy_config;
